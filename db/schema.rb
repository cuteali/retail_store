...
ActiveRecord::Schema.define(version: 20160629031626) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.boolean  "is_app_tag",               default: false, null: false
    t.integer  "status",       limit: 1,   default: 0,     null: false
    t.datetime "created_at",                               null: false
    t.datetime "updated_at",                               null: false
  end
  ...
  create_table "shop_products", force: :cascade do |t|
    ...
    t.decimal  "price",                          precision: 12, scale: 2, default: 0.0
    t.decimal  "old_price",                      precision: 12, scale: 2, default: 0.0
    t.integer  "stock_volume",       limit: 4,                            default: 0
    t.integer  "sales_volume",       limit: 4,                            default: 0
    t.string   "key",                limit: 255
    t.string   "desc",               limit: 255
    t.string   "info",               limit: 255
    t.string   "spec",               limit: 255
  ...
  create_table "shops", force: :cascade do |t|
    ...
    t.decimal  "freight",                    precision: 12, scale: 2, default: 0.0, null: false
    t.integer  "init_status",    limit: 1,                            default: 0,   null: false
    t.integer  "status",         limit: 1,                            default: 0,   null: false
    t.datetime "created_at",                                                        null: false
    t.datetime "updated_at",                                                        null: false
  end
